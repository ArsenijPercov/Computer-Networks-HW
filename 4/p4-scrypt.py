...
if __name__ == '__main__':
    ...
    print(f1.cmd("bird6 -c ./f1-bird.conf -s /var/run/f1-bird.ctl"))
    print(f2.cmd("bird6 -c ./f2-bird.conf -s /var/run/f2-bird.ctl"))
    print(f3.cmd("bird6 -c ./f3-bird.conf -s /var/run/f3-bird.ctl"))
    print(f4.cmd("bird6 -c ./f4-bird.conf -s /var/run/f4-bird.ctl"))

    print(e1.cmd("bird6 -c ./e1-bird.conf -s /var/run/e1-bird.ctl"))
    print(e2.cmd("bird6 -c ./e2-bird.conf -s /var/run/e2-bird.ctl"))
    print(e3.cmd("bird6 -c ./e3-bird.conf -s /var/run/e3-bird.ctl"))
    print(e4.cmd("bird6 -c ./e4-bird.conf -s /var/run/e4-bird.ctl"))
